...
Os dados utilizados na pesquisa foram construídos a partir de fontes públicas e institucionais (Petrobras, Federal Reserve Bank of St. Louis – FRED, e IPEADATA), conforme detalhado no TCC. Por questões de organização e reprodutibilidade conceitual, os arquivos de dados não estão incluídos neste repositório.
